...
namespace QFSW.QC.Editor
{
    ...
    public class QuantumThemeInspector : QCInspectorBase
    {
        ...
        private SerializedProperty _debugColorProperty;
        ...
        protected override void OnEnable()
        {
            ...
            _debugColorProperty = serializedObject.FindProperty("DebugColor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_debugColorProperty, new GUIContent("Debug Color", "The color to use when formatting debug in the console log."));
